...
const ModalCard = ({ bankName, fintechUseNo, tofintechno }) => {
  ...
  const genTransId = () => {
    ...
    const clientNo = "M202300422U";
    let transId = clientNo + countnum;
    return transId;
  };
  ...
  const deposit = () => { //입금
    const twoLeggedToken =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiJNMjAyMzAwNDIyIiwic2NvcGUiOlsib29iIl0sImlzcyI6Imh0dHBzOi8vd3d3Lm9wZW5iYW5raW5nLm9yLmtyIiwiZXhwIjoxNzAyNDUzNTMyLCJqdGkiOiI5YzVhZDcyOS0wYjNmLTQ4NTEtOGViZS0yYTAwZjU1NGIyMDgifQ.EG1dhTDbL-hPVYa0ePbbFY2rKckMTSdVkTYoE9Eiw5c";
    const data = {
      cntr_account_type: "N",
